...
internal protocol SAPhotoBrowserViewDelegate: NSObjectProtocol {
    ...
    @objc optional func browserView(_ browserView: SAPhotoBrowserView, shouldRotation photo: SAPhoto) -> Bool
    @objc optional func browserView(_ browserView: SAPhotoBrowserView, didRotation photo: SAPhoto, orientation: UIImageOrientation)
}
...
extension SAPhotoBrowserView: SAPhotoContainterViewDelegate {
    ...
    public func viewForZooming(in containterView: SAPhotoContainterView) -> UIView? {
        return _imageView
    }
