...
public enum SAPhotoBarItemType: Int {
    case normal
    case original
    case send
}

open class SAPhotoBarItem: UIBarButtonItem {
    
    open var type: SAPhotoBarItemType
    ...
    public init(title: String?, type: SAPhotoBarItemType = .normal, target: AnyObject? = nil, action: Selector? = nil) {
        self.type = type
        super.init()
        self.title = title
        self.target = target
