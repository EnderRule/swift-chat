...
internal class SAEmotionBackgroundView: UIView {
    ...
    private func _init() {
        ...
        addConstraint(_SALayoutConstraintMake(_leftView, .top, .equal, self, .top))
        addConstraint(_SALayoutConstraintMake(_leftView, .left, .equal, self, .left, priority: 751))
        addConstraint(_SALayoutConstraintMake(_leftView, .right, .equal, _middleView, .left))
        addConstraint(_SALayoutConstraintMake(_leftView, .bottom, .equal, self, .bottom))
        
        addConstraint(_SALayoutConstraintMake(_middleView, .top, .equal, self, .top))
        addConstraint(_SALayoutConstraintMake(_middleView, .centerX, .equal, self, .left, output: &_middleViewCenterX))
        addConstraint(_SALayoutConstraintMake(_middleView, .bottom, .equal, self, .bottom, output: &_middleViewBottom))
        
        addConstraint(_SALayoutConstraintMake(_rightView, .top, .equal, self, .top))
        addConstraint(_SALayoutConstraintMake(_rightView, .left, .equal, _middleView, .right))
        addConstraint(_SALayoutConstraintMake(_rightView, .right, .equal, self, .right, priority: 751))
        addConstraint(_SALayoutConstraintMake(_rightView, .bottom, .equal, self, .bottom))
    }
