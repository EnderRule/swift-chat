...
@objc open class SAEmotionPanel: UIView, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, SAEmotionDelegate {
    ...
    private func _init() {
        ...
        _moreButton.translatesAutoresizingMaskIntoConstraints = false
        ...
        addConstraint(_SALayoutConstraintMake(_moreButton, .top, .equal, _tabbar, .top))
        addConstraint(_SALayoutConstraintMake(_moreButton, .right, .equal, _tabbar, .right))
        addConstraint(_SALayoutConstraintMake(_moreButton, .bottom, .equal, _tabbar, .bottom))
        
        addConstraint(_SALayoutConstraintMake(_moreButton, .width, .equal, nil, .notAnAttribute, 60))
    }
    ...
    private lazy var _moreButton: UIButton = UIButton()
