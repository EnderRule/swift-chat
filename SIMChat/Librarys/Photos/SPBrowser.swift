...
open class SPBrowser: UIViewController {
//    
////    open weak var delegate: SPPreviewerDelegate?
////    open weak var dataSource: SPPreviewerDataSource?
//    
...
//        _contentView.register(SPPreviewerCell.self, forCellWithReuseIdentifier: "Item")
...
//    
//    fileprivate var _allLoader: [Int: SPhotoLoader] = [:]
//}
//
//extension SPBrowser: SPBrowserViewDelegate {
//    
//    func browserView(_ browserView: SPBrowserView, didTapWith sender: AnyObject) {
//        _logger.trace()
//        
...
//    }
//    func browserView(_ browserView: SPBrowserView, didDoubleTapWith sender: AnyObject) {
//        _logger.trace()
//        
//        // 双击的时候隐藏
...
//    }
//    
//    func browserView(_ browserView: SPBrowserView, shouldRotation orientation: UIImageOrientation) -> Bool {
//        _logger.trace()
//        
//        _contentView.isScrollEnabled = false
//        return true
//    }
//    
//    func browserView(_ browserView: SPBrowserView, didRotation orientation: UIImageOrientation) {
//        _logger.trace()
//        
...
//}
//
//extension SPBrowser: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
//    
...
////                let loader = SPhotoLoader(photo: photo)
