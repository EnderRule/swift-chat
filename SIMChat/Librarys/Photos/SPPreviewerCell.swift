...
internal protocol SPPreviewerCellDelegate: NSObjectProtocol {
...
internal class SPPreviewerCell: UICollectionViewCell, SPContainterViewDelegate {
    
    weak var delegate: SPPreviewerCellDelegate? {
    ...
    private weak var _delegate: SPPreviewerCellDelegate?
    
    private lazy var _contentView: UIView = UIView()
    private lazy var _containterView: SPContainterView = SPContainterView()
...
extension SPPreviewerCell: SPPreviewable {
...
//internal class SPBrowserView: UIView, SPPreviewable {
//    
//    
...
//    }
//    
//    weak var delegate: SPBrowserViewDelegate? {
//        set { return _delegate = newValue }
//        get { return _delegate }
//    }
////
...
////    }
////    
//////    fileprivate func _updateContent(for loader: SPhotoLoaderType, animated: Bool) {
//////        //_logger.trace()
//////        
...
//    
//    fileprivate weak var _delegate: SPBrowserViewDelegate?
//
...
//    
//    fileprivate lazy var _imageView: SPImageView = SPImageView()
//    fileprivate lazy var _containterView: SPContainterView = SPContainterView()
//    
//    override init(frame: CGRect) {
//        super.init(frame: frame)
//        _init()
...
////}
////
////private extension SPBrowserView {
////    
////
////}
////
////extension SPBrowserView: UIGestureRecognizerDelegate {
////    
...
//}
//
//extension SPBrowserView: SPContainterViewDelegate {
//    
//}
