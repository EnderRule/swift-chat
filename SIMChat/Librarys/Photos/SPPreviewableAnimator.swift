...
public class SPPreviewableAnimator: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    public static func pop(item: AnyObject, from: SPPreviewableDelegate, to: SPPreviewableDelegate) -> SPPreviewableAnimator? {
        return SPPreviewablePopAnimator(item: item, from: from, to: to)
    }
    public static func push(item: AnyObject, from: SPPreviewableDelegate, to: SPPreviewableDelegate) -> SPPreviewableAnimator? {
        return SPPreviewablePushAnimator(item: item, from: from, to: to)
    }
    
    fileprivate var _item: AnyObject
    
    fileprivate var _tContext: SPPreviewable
    fileprivate var _fContext: SPPreviewable
    
    fileprivate weak var _tDelegate: SPPreviewableDelegate?
    fileprivate weak var _fDelegate: SPPreviewableDelegate?
    
    fileprivate init?(item: AnyObject, from: SPPreviewableDelegate, to: SPPreviewableDelegate) {
...
internal class SPPreviewablePushAnimator: SPPreviewableAnimator {
    ...
    override func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        let previewView = SPPreviewableView()
...
internal class SPPreviewablePopAnimator: SPPreviewableAnimator {
    // This method can only  be a nop if the transition is interactive and not a percentDriven interactive transition.
    override func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        //_logger.trace()
