...
@objc
internal protocol SPBrowserViewDelegate: NSObjectProtocol {
    
    @objc optional func browserView(_ browserView: SPBrowserView, photo: SPAsset, didTapWith sender: AnyObject)
    @objc optional func browserView(_ browserView: SPBrowserView, photo: SPAsset, didDoubleTapWith sender: AnyObject)
    
    @objc optional func browserView(_ browserView: SPBrowserView, shouldRotation photo: SPAsset) -> Bool
    @objc optional func browserView(_ browserView: SPBrowserView, didRotation photo: SPAsset, orientation: UIImageOrientation)
}

internal class SPBrowserViewFastPreviewing: NSObject, SPPreviewable {
    ...
    init(photo: SPAsset, view: UIView) {
        self.view = view
        self.photo = photo
        super.init()
    }
...
extension SPBrowserView: SPContainterViewDelegate {
    ...
    public func viewForZooming(in containterView: SPContainterView) -> UIView? {
        return _imageView
    }
