...
internal class SPBadgeView: UIView {
    
    var style: SPBadgeSytle = .normal
    
    var badge: SPBadge = .normal {
        didSet {
...
//                ]
    ...
    var duration: TimeInterval? {
        didSet {
            ...
            _rightView?.text = SPStringForDuration(duration)
        }
    }
    ...
    func _image(with badge: SPBadge) -> UIImage? {
    ...
    convenience init(style: SPBadgeSytle) {
        self.init()
        self.style = style
    }
}
