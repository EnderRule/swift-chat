...
internal class SPPickerAlbums: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        tableView.register(SPPickerAlbumsCell.self, forCellReuseIdentifier: "Item")
    ...
    private func _updateStatus(_ newValue: SPhotoStatus) {
    ...
    private func _albumsIsEmpty(_ albums: [SPAlbum]) -> Bool {
    ...
    private weak var _assetsViewController: SPPickerAssets?
    private weak var _previewerViewController: SPPreviewer?
    
    private var _toolbarItems: [UIBarButtonItem]??
    
    fileprivate var _initPreviewer: SPPreviewer?
    
    fileprivate var _albums: [SPAlbum]?
    fileprivate var _albumForPicker: SPAlbum?
}

// MARK: - UITableViewDelegate & UITableViewDataSource 

extension SPPickerAlbums {
    ...
    override func tableView(_ tableView: UITableView, willDisplay cell: UITableViewCell, forRowAt indexPath: IndexPath) {
        guard let cell = cell as? SPPickerAlbumsCell else {
            return
        }
...
extension SPPickerAlbums: PHPhotoLibraryChangeObserver {
