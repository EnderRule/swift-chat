...
public enum SPButtonBarItemType: Int {
    case normal
    case original
    case send
}

open class SPButtonBarItem: UIBarButtonItem {
    
    open var type: SPButtonBarItemType
    ...
    public init(title: String?, type: SPButtonBarItemType = .normal, target: AnyObject? = nil, action: Selector? = nil) {
        self.type = type
        super.init()
        self.title = title
        self.target = target
    ...
    func toBarItem() -> UIBarButtonItem {
        ...
        let item: UIBarButtonItem = {
            ...
            case .original:
                ...
                if !isSelected {
                    view.setImage(UIImage(named: "photo_small_checkbox_normal"), for: .normal)
                    view.setImage(UIImage(named: "photo_small_checkbox_selected"), for: .selected)
                } else {
                    view.setImage(UIImage(named: "photo_small_checkbox_normal"), for: .selected)
                    view.setImage(UIImage(named: "photo_small_checkbox_selected"), for: .normal)
                }
                view.sizeToFit()
                return UIBarButtonItem(customView: view)
