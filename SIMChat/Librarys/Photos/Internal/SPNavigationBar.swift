...
internal protocol SPNavigationBarDelegate: UINavigationBarDelegate {
    ...
    @objc optional func sa_navigationBar(_ navigationBar: SPNavigationBar, shouldPop item: UINavigationItem) -> Bool
    @objc optional func sa_navigationBar(_ navigationBar: SPNavigationBar, didPop item: UINavigationItem)
