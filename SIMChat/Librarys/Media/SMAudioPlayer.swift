...
/// TODO: 支持网络文件
///
@objc open class SMAudioPlayer: NSObject, AVAudioPlayerDelegate {
    ...
    // the delegate will be sent messages from the SMAudioPlayerDelegate protocol
    open weak var delegate: SMAudioPlayerDelegate?
...
/// 音频播放器代理
///
@objc public protocol SMAudioPlayerDelegate {

    @objc optional func audioPlayer(shouldPreparing audioPlayer: SMAudioPlayer) -> Bool
    @objc optional func audioPlayer(didPreparing audioPlayer: SMAudioPlayer)
    
    @objc optional func audioPlayer(shouldPlaying audioPlayer: SMAudioPlayer) -> Bool
    @objc optional func audioPlayer(didPlaying audioPlayer: SMAudioPlayer)
    
    @objc optional func audioPlayer(didPause audioPlayer: SMAudioPlayer)
    
    @objc optional func audioPlayer(didStop audioPlayer: SMAudioPlayer)
    @objc optional func audioPlayer(didInterruption audioPlayer: SMAudioPlayer)
    
    // audioPlayerDidFinishPlaying:successfully: is called when a sound has finished playing. This method is NOT called if the player is stopped due to an interruption.
    @objc optional func audioPlayer(didFinishPlaying audioPlayer: SMAudioPlayer, successfully flag: Bool)
    
    // if an error occurs will be reported to the delegate.
    @objc optional func audioPlayer(didOccur audioPlayer: SMAudioPlayer, error: Error?)
}
