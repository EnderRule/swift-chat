...
open class SMVideoPlayer: NSObject, SMPlayerProtocol {
    ...
    // the player status
    open var status: SMVideoPlayerStatus {
        return _status
    }
    ...
    // an delegate
    open weak var delegate: SMVideoPlayerDelegate? {
    ...
    fileprivate var _status: SMVideoPlayerStatus = .stop
    
    fileprivate var _isActived: Bool = false
    
    fileprivate weak var _delegate: SMVideoPlayerDelegate?
...
private extension SMVideoPlayer {
