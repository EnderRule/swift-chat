...
//            SACBundle.imageWithResource("InputPanel/\(n).png")
//        }
//        return [
//            SAIToolboxItem("page:voip", "网络电话", R("tool_voip")),
//            SAIToolboxItem("page:video", "视频电话", R("tool_video")),
//            SAIToolboxItem("page:video_s", "短视频", R("tool_video_short")),
//            SAIToolboxItem("page:favorite", "收藏", R("tool_favorite")),
//            SAIToolboxItem("page:red_pack", "发红包", R("tool_red_pack")),
//            SAIToolboxItem("page:transfer", "转帐", R("tool_transfer")),
//            SAIToolboxItem("page:shake", "抖一抖", R("tool_shake")),
//            SAIToolboxItem("page:file", "文件", R("tool_folder")),
//            SAIToolboxItem("page:camera", "照相机", R("tool_camera")),
//            SAIToolboxItem("page:pic", "相册", R("tool_pic")),
//            SAIToolboxItem("page:ptt", "录音", R("tool_ptt")),
//            SAIToolboxItem("page:music", "音乐", R("tool_music")),
//            SAIToolboxItem("page:location", "位置", R("tool_location")),
//            SAIToolboxItem("page:nameplate", "名片",   R("tool_share_nameplate")),
//            SAIToolboxItem("page:aa", "AA制", R("tool_aa_collection")),
//            SAIToolboxItem("page:gapp", "群应用", R("tool_group_app")),
//            SAIToolboxItem("page:gvote", "群投票", R("tool_group_vote")),
//            SAIToolboxItem("page:gvideo", "群视频", R("tool_group_video")),
//            SAIToolboxItem("page:gtopic", "群话题", R("tool_group_topic")),
//            SAIToolboxItem("page:gactivity", "群活动", R("tool_group_activity"))
//        ]
//    }()
//    
...
//
//extension SACViewController: SAInputBarDelegate, SAInputBarDisplayable {
//    
...
//
//extension SACViewController: SAIAudioInputViewDataSource, SAIAudioInputViewDelegate {
//    
...
//
//extension SACViewController: SAIEmoticonInputViewDataSource, SAIEmoticonInputViewDelegate {
// 
...
//
//extension SACViewController: SAIToolboxInputViewDataSource, SAIToolboxInputViewDelegate {
//    
