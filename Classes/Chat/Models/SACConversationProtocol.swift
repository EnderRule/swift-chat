...
/// 抽象的会话协议.
///
public protocol SACConversationProtocol: class {
    
    /// 发送者
    var sender: SACUserProtocol { get }
    
    /// 接收者
    var receiver: SACUserProtocol { get }
...
//    ///
//    static func conversation(_ receiver: SACUserProtocol, manager: SIMChatManager) -> SIMChatConversation
//}
//
//// MARK: - Convenience
//
